...
try {
    ...
    # Check for hos-home marker (in HTML template or rendered)
...
# Step C: Marketplace demo route (removed in V1)
Write-Host ""
Write-Host "[C] Marketplace demo route check skipped (V1: no demo routes)" -ForegroundColor Yellow
...
# Step F: Marketplace need-demo route (removed in V1)
Write-Host ""
Write-Host "[F] Marketplace need-demo route check skipped (V1: no demo routes)" -ForegroundColor Yellow
...
if ($hasFailures) {
  ...
  Write-Host "  - HOS Web: PASS (hos-home marker)" -ForegroundColor Gray
  Write-Host "  - Marketplace demo route: SKIP (V1: removed)" -ForegroundColor Gray
