...
# Helper: Get PowerShell executable (pwsh if available, else powershell.exe)
...
$secretScanOutput = & $PowerShellExe -NoProfile -ExecutionPolicy Bypass -File $secretScanScript 2>&1
...
$publicReadyOutput = & $PowerShellExe -NoProfile -ExecutionPolicy Bypass -File $publicReadyScript 2>&1
