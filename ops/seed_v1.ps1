...
Write-Host "=== SEED V1 (WP-69) ===" -ForegroundColor Cyan
...
Write-Host "PASS: Seed listings defined ($($demoListings.Count) listings)" -ForegroundColor Green
...
Write-Host ""
Write-Host "=== SEED V1 SUMMARY ===" -ForegroundColor Cyan
Write-Host ""
...
if ($hasFailures) {
    Write-Host "=== SEED V1: FAIL ===" -ForegroundColor Red
    exit 1
} else {
    Write-Host "=== SEED V1: PASS ===" -ForegroundColor Green
    exit 0
}
