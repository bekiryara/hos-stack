...
Write-Host "DEPRECATED: work/hos/ops/alert_slack_test.ps1 is retired." -ForegroundColor Yellow
Write-Host "Use canonical ops from repo root:" -ForegroundColor Yellow
