...
import RentalDetailPage from './pages/RentalDetailPage.vue';
...
import FirmSettingsPage from './pages/FirmSettingsPage.vue';
...
const routes = [
  ...
  { path: '/firm/settings', component: FirmSettingsPage, meta: { requiresAuth: true, requiresFirm: true } },
