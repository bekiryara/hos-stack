    ...
    async refreshAll() {
      ...
      try {
        ...
        if (rentalsResp.error) {
          const err = rentalsResp.error;
          this.error = {
            status: err.status || 0,
            message: err.message || 'Failed to load rentals',
        ...
        if (reservationsResp.error) {
          const err = reservationsResp.error;
          this.error = {
            status: err.status || 0,
            message: err.message || 'Failed to load reservations',
